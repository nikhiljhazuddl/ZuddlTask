...
const Navbar = ({ activeMenu }) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100 sticky top-0 z-10 p-4 flex items-center justify-between">
      ...
      <h2 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Zuddl Task</h2>
